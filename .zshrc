...
alias todo="vim ~/MEGA/arch"
alias zconf="vim ~/.zshrc"
alias xrconf="vim ~/.Xresources"
alias viconf="vim ~/.vimrc"
#Awesome
alias awconf="vim ~/.config/awesome/rc.lua"
alias awstart="vim ~/.config/awesome/autorun.sh"
#Openbox
alias opconf="vim ~/.config/openbox/rc.xml"
alias opstart="vim ~/.config/openbox/autostart"
#Grub
